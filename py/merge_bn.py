...
def get_args():
    ...
    parser.add_argument('--model', default="example/MobileNetSSD_deploy.prototxt")
    parser.add_argument('--weights', default=dataset+"/mobilenet_iter_73000.caffemodel")
    parser.add_argument('--outmodel', default=dataset+"/MobileNetSSD_deploy.prototxt")
    parser.add_argument('--outweights', default=dataset+"/MobileNetSSD.caffemodel")
...
if __name__ == '__main__':
    args = get_args()
    pre_process(args.model, args.outmodel)

    net = caffe.Net(args.model, args.weights, caffe.TEST)  
    net2 = caffe.Net(args.outmodel, caffe.TEST)

    load_weights(net, net2)
    net2.save(args.outweights)
