...
save_dir = "models/"+datasetname+"_{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/"+datasetname+"_{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/"+datasetname+"_{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/VOCdevkit/results/"+datasetname+"/{}_score/Main".format(os.environ['HOME'], job_name)
